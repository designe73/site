...
import { AuthProvider } from "@/hooks/useAuth"; // ✅ On réactive ceci
import { CartProvider } from "@/hooks/useCart"; // ✅ On réactive ceci
  ...
  <ErrorBoundary>
    <HelmetProvider context={helmetContext}>
      <QueryClientProvider client={queryClient}>
        {/* ✅ L'AuthProvider doit envelopper tout le reste pour que useAuth fonctionne */}
        <AuthProvider>
          <CartProvider>
