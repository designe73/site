...
// import { useAdminPushNotifications } from '@/hooks/useAdminPushNotifications'; // ⚠️ Keep this line commented out until the main app is stable
...
  // ⚠️ Keep this commented out until everything is stable:
...
  // 1. Écran de chargement explicite
  if (loading) {
    return (
...
  // 2. Redirection sécurisée (Si pas connecté ou pas modérateur)
  if (!user || !isModerator) {
    return <Navigate to="/admin/connexion" state={{ from: location }} replace />;
  }

  // 3. Protection des routes Admin pour les Modérateurs
